talos_nodes = {
  "ctrl-0" = {
    ...
    vm_id          = 1000
    cpu            = 8    # Increased from 6 (was less than workers!)
    ram_dedicated  = 16384  # Reduced from 24GB to 16GB to prevent swap
  ...
  "worker-1" = {
    ...
    vm_id          = 1001
    cpu            = 5
    ram_dedicated  = 28672  # Reduced from 32GB to 28GB to prevent swap
    datastore_id   = "local-zfs"
    os_disk_size   = 50    # OS + /var/lib/rook monitors (conservative)
  ...
  "worker-3" = {
    ...
    vm_id          = 1003
    cpu            = 8
    ram_dedicated  = 20480  # Reduced from 24GB to 20GB to prevent swap
    datastore_id   = "local-zfs"
    os_disk_size   = 50    # OS + /var/lib/rook monitors (conservative)
    ceph_disk_size = 200   # Ceph OSD (conservative 4x increase)
  }
