...
### **Our GitOps Patterns**
- [ArgoCD Applications](/kubernetes/40-observability-crds/README.md)
- [ServiceMonitor Configuration](/kubernetes/40-observability-crds/SERVICEMONITOR_README.md)
- [Prometheus Setup](/kubernetes/40-observability-crds/prometheus/README.md)
